let elementTypes = [
    {type: 'noble-gas', color: '#bc00ff'},
    {type: 'alkali-metal', color: '#fa7900'},
    {type: 'alkaline-earth', color: '#f0ff0a'},
    {type: 'nonmetal', color: '#0207f5'},
    {type: 'basic-metal', color: '#f00'},
    {type: 'semimetal', color: '#6788ff'},
    {type: 'transition-metal', color: '#55f500'},
